...
function App() {
  ...
  const methodsData = [
    {
      ...
      description: "De Experimenteer methode sprak mij persoonlijk niet zo aan. Ik werk altijd heel doelgericht naar een eindproduct toe. Bij deze methode voelde ik me erg teruggehouden door het feit dat we per idee/functionaliteit moesten testen en dat er soms leuke dingen geschrapt moesten worden.  ",
  ...
  const groupProjectsData = [
    {
      ...
      pros: ["Tijdens dit project ben ik bezig geweest met de API van openAI en google books. Dit was een leerzame ervaring.", "Tijdens dit project heb ik veel gecodeerd, veel grote taken op me genomen", "Na de eerste week nam ik een wat meer leidinggevende rol op me en probeerde ik overzicht te creëren voor iedereen."],
      cons: ["Ik heb veel thuis moeten doen omdat ik teveel op me nam", "In de eerste week nam iemand anders de leiding en gaf ik heel weinig input", "Communicatie had beter gemoeten om overzicht te behouden, zo hoefde ik me ook niet overal mee te bemoeien", "We waren niet concreet genoeg in wat we wilden testen en wat hiervoor gebouwd moest worden."],
  ...
  const futurePlansData = "In de toekomst wil ik vooral mijn enthousiasme voor het bouwen van functionaliteiten behouden. Waar ik me extra op wil richten is het communiceren en samentrekken van onze doelstelling. Dit wil ik doen door erg kritisch te blijven en veel vragen te stellen aan mijn groepsgenoten. Wat ik realistisch? Ligt iedereen op 1 lijn? Waarom willen we functionaliteit x toevoegen en is dit het waard? Zo hoop ik toekomstige projecten zo soepel mogelijk te laten verlopen.";
